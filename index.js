$(document).ready(function(){
    ...
    addItem.click(function(){
    	...
    	if(!deletemode && !movemode){
          ...
          itemcontainer.append("<div id='event" + eventid + "' class='event'><span contenteditable='true'></span><span class='close'><i class='material-icons'></i></span></div>");
          if(deletemode){
    ...
    addList.click(function(){
        itemcontainer.append("<div class='list'><h1><span contenteditable='true'></span></h1><span class='close'><i class='material-icons'></i></span></div>");
        $(".list").click(function(){
    ...
    addHeading.click(function(){
    	...
    	if(!deletemode && !movemode){
          ...
          itemcontainer.append("<div id='event" + eventid + "' class='event'><h2><span contenteditable='true'></span></h2><span class='close'><i class='material-icons'></i></span></div>");
          if(deletemode){
              deleteItem.addClass("buttonSelected");
              events.addClass("deleteEvent");
              $("#event"+eventid).addClass("deleteEvent");
    ...
    function loadlistfunction(){
        ...
        if(loadlist != "" && loadlist != null){
            ...
            for(var k = 0; k < splitlist.length; k++){
                if(splitlist[k] != ""){              
                  itemcontainer.append("<div id='event"+k+"'class='event'><span contenteditable='true'>"+splitlist[k]+"</span><span class='close'><i class='material-icons'></i></span></div>");
